      ...
      >
        ...
        <div className="space-y-3">
          <a
            ...
            className="flex items-center gap-3 p-3.5 rounded-xl border border-border hover:shadow-card hover:-translate-y-0.5 transition-all duration-200 group"
          >
          ...
          >
            <div className="w-9 h-9 rounded-lg bg-secondary flex items-center justify-center">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground" aria-hidden="true">
